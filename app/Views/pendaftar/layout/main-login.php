            ...
            <div class="sidebar-wrapper scrollbar scrollbar-inner">
                <div class="sidebar-content">
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item <?= (uri_string() == 'pendaftar/progress' || strpos(uri_string(), 'pendaftar/progress-detail') !== false || strpos(uri_string(), 'pendaftar/detail-pembayaran') !== false || strpos(uri_string(), 'pendaftar/tambah-pembayaran') !== false || strpos(uri_string(), 'pendaftar/tambah-riwayat-pembayaran') !== false) ? 'active' : '' ?>">
                            <a href="<?= base_url("pendaftar/progress") ?>">
                                <i class="fas fa-pen-square"></i>
                                <p>Projek</p>
                            </a>
                        </li>
                        <li class="nav-item <?= (uri_string() == 'pendaftar/profile' || uri_string() == 'pendaftar/updateProfile') ? 'active' : '' ?>">
                            <a href="<?= base_url("pendaftar/profile") ?>">
                                <i class="fas fa-user"></i>
                                <p>Profile</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url("pendaftar/logout") ?>">
                            ...
                            <li class="nav-item topbar-user dropdown hidden-caret">
                                ...
                                <ul class="dropdown-menu dropdown-user animated fadeIn">
                                    <div class="dropdown-user-scroll scrollbar-outer">
                                        <li>
                                            <a class="dropdown-item" href="<?= base_url("pendaftar/logout") ?>">Logout</a>
                                        </li>
                                    </div>
                                </ul>
                            </li>
