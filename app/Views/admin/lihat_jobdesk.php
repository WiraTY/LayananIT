                    ...
                    <table class="table table-head-bg-secondary mt-1">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Progress Projek (%)</th>
                        ...
                        <tbody>
                            <?php foreach ($projek as $key => $projekItem) : ?>
                                <tr>
                                    ...
                                    <td><?= esc($projekItem['progress_projek'] ?? 0) ?></td>
                                    <!-- <td>
                                        <a href="<?= base_url('programmer/progress/' . $projekItem['id_projek']) ?>" class="btn btn-info btn-sm">Projek</a>
                                    </td> -->
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
